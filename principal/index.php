...
<html lang="en">
    ...
    <header class="mn-header navbar-fixed">
                <nav style= "background-image: linear-gradient(to right, rgba(62, 0, 0), rgba(0, 20, 109))" class="cyan darken-1">
                        ...
                        <div style="margin-left: 0px;" class="header-title col s4">      
                            <span  class="chapter-title">SIMAT LMS | PRINCIPAL LOGIN</span>
    ...
    <body class="signin-page" style="background-image: linear-gradient(to right, rgba(40, 0, 0), rgba(0, 14, 77));opacity:2" class="mn-content valign-wrapper">>
            ...
            <main class="mn-inner container">
                ...
                <div class="valign">
                      <div class="row">
                          ...
                          <h4 style="font-family: Garamond, serif; text-align:center;color:white">Principal Login</h4>
