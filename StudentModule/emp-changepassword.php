...
$username=$_SESSION['stlogin'];
    $sql ="SELECT Password FROM stlogin WHERE email=:username and Password=:password";
...
if($query -> rowCount() > 0)
{
$con="UPDATE stlogin set password=:newpassword where email=:username";
