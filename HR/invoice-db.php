...
// {          -->
  ...
  <?php 
  $sql = "SELECT tblprincipal.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblemployees.Designation,tblemployees.Department,tblemployees.lv_casual,tblprincipal.LeaveType,tblprincipal.PostingDate,tblprincipal.Status=1 from tblprincipal join tblemployees on tblprincipal.empid=tblemployees.EmpId order by lid desc";
  +
