                        ...
                        <div class="card">
                            <div class="card-content">
                                ...
                                <table id="example" class="display responsive-table ">
                                    ...
                                    <tbody>
<?php $sql = "SELECT tblprincipal.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblprincipal.LeaveType,tblprincipal.PostingDate,tblprincipal.Status from tblprincipal join tblemployees on tblprincipal.empid=tblemployees.EmpID order by lid desc";
...
if($stats==1){
                                             ?>
                                                ...
                                                <?php } if($stats==3)  { ?>
                                                <span style="color: chocolate">Waiting for Approval from Principal</span>
                                                <?php } ?>
